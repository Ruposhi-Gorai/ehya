  ...
  <div class="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        ...
        <ul class="flex justify-center text-white gap-6 mt-8 md:gap-8 sm:justify-start">
          <li>
           <span><FaGoogle/></span>
      ...
      >
        <div class="text-center sm:text-left">
          <p class="text-lg font-medium text-white">Products</p>
        ...
        <div class="text-center sm:text-left">
          <p class="text-lg font-medium text-white">More</p>
